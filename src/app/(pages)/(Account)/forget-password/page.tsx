              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-600">
                    Don&apos;t worry, it happens to the best of us. We&lsquo;ll
                    help you get back into your account in no time.
                  </p>
                  <div className="flex items-center justify-center space-x-8 text-sm text-gray-500">
                    <div className="flex items-center">
                      <FaTruck className="text-green-600 mr-2" /> Email
                      Verification
                    </div>
                    <div className="flex items-center">
                      <FaShieldAlt className="text-green-600 mr-2" /> Secure
                      Reset
                    </div>
                    <div className="flex items-center">
